...
**Ring Attention** — Liu et al. 2023. Production versions live in Megatron's `context_parallel` (p2p ring or all-gather comm types) and in flash-attn with zigzag sharding.

**Our toy** — §3's three formulas transcribed. Read it line-against-line with the math.
